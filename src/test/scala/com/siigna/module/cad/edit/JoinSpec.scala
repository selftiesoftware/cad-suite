...
class JoinSpec extends FunSpec with ShouldMatchers  {
  ...
  describe("joining of shapes... ") {
    ...
    it("works with more than two segments") {
      ...
      val p6 = Vector2D(20,20)
      val p7 = Vector2D(30,20)

      val p8 =  Vector2D(40,0)
      val p9 =  Vector2D(40,20)

      val pl1 = PolylineShape(p1,p2,p3,p4)
      val pl2 = PolylineShape(p5,p6,p7)
      val pl3 = PolylineShape(p8,p9)

      val selection1 = Map(1 -> pl1)
      val selection2 = Map(1 -> pl1,2 -> pl2)
      val selection3 = Map(1 -> pl1,2 -> pl2, 3 -> pl3)
