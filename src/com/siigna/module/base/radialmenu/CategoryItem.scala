 ...
 */
class CategoryItem (val module : Symbol, val icon : Traversable[Shape], val modulePath : String) extends MenuElement
...
object CategoryItem {
  ...
  def apply(module : Symbol, icon : Shape) : CategoryItem = CategoryItem(module, Traversable[Shape](icon))
  def apply(module : Symbol, icon : Shape, modulePath : String) : CategoryItem =new CategoryItem(module, Traversable[Shape](icon), "com.siigna.module.base." + modulePath)
  def apply(module : Symbol, icon : Traversable[Shape]) = new CategoryItem(module, icon, "com.siigna.module.base." + module.name)
  def apply(module : Symbol, icon : Traversable[Shape], modulePath : String) = {
    if (modulePath.startsWith("com.siigna")) { // Don't write the path twice
      new CategoryItem(module, icon, modulePath)
      ...
      new CategoryItem(module, icon, "com.siigna.module.base." + modulePath)
    }
  }
